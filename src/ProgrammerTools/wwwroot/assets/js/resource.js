...
function getVueRotesInternal(current) {
    ...
    if (current.path) {
        ...
        for (let i = 0; i < current.children.length; i++) routes = routes.concat(getVueRotesInternal(current.children[i]));
    }
    return routes;
}
